...
module.exports = async(interaction, client) => {
    ...
    if (interaction.customId === "help_menu") {
        ...
        .setTitle("Configurasi")
        .setDescription(
          "`autorole`, `antilink`, `antiwords`, `joinchannel`, `joinmessage`, `leavechannel`, `leavemessage`, `dashboard`, `prefix`"
        )
        .setColor("RANDOM");
      ...
      await msg.edit({ embeds: [settingsEmbed] });
        ...
        .setDescription(
          "`8ball`, `ascii`, `clap`, `cium`, `clyde`, `cowsay`, `dab`, `emojify`, `fliptext`, `gif`, `greentext`, `hack`, `howgay`, `meme`, `nitro`, `peluk`, `humor`, `bunuh`, `orangetext`, `pokeimg`, `pp`, `respect`, `reverse`, `hujat`, `tampar`, `trivia`,  `vaportext`, `yomama`"
        )
        .setColor("RANDOM");
        ...
        await msg.edit({ embeds: [funEmbed] });
            ...
            .setDescription(
              "`afraid`, `alert`, `amazeme`, `biden`,`changemymind`, `clyde`, `creatememe`, `cryingfloor`, `disastergirl`, `dockofshame`, `doge`, `drake`, `facepalm`, `feelsgood`, `illegal`, `keanu`, `memetemplates`, `trigger`, `trumptweet`, `wasted`, `wideavatar`"
            )
        ...
        .setDescription(
          "`botinfo`, `emojiid`, `help`, `invite`, `ping`, `aturan`, `report`, `userinfo`, `userid`, `statistik`, `masukan`"
        )
        .setColor("RANDOM");
        ...
        await msg.edit({ embeds: [infoEmbed] })
            ...
            .setDescription(
              "`kick`, `ban`, `softban`, `dm`, `mute`, `unmute`, `tempmute`"
            )
            .setColor("RANDOM");
            ...
            if (!interaction.channel.nsfw) {
              ...
              .setDescription(
                  "`4k`, `anal`, `asian`, `ass`, `blowjob`, `bokep`, `boobs`, `cumsluts`, `erokemo`, `danbooru`, `kitsune`, `hentai`, `hentaiass`, `hentaithigh`, `gonewild`, `milf`, `feetgif`, `pussy`, `porngif`, `urban`, `thigh`, `lewd`"
              )
              .setColor("RANDOM");
        ...
        .setDescription(
          "`avatar`, `animesearch`, `pengumuman`, `kalkulator`, `hapus`, `createrole`, `delchannel`, `delrole`, `enlargemoji`, `esay`, `giverole`, `google`, `imdb`, `lock`, `newtext`, `newvoice`, `nickname`, `nuke`, `poll`, `removerole`, `say`, `servericon`, `serverinfo`, `userinfo`, `masukan`, `terjemah`, `unlock`, `cuaca`, `wiki`"
        )
        .setColor("RANDOM");
        ...
        .setDescription(
          "`awkword`, `betrayal`, `catur`, `doodlecrew`, `fishington`, `lettertile`, `poker`, `spellcast`, `youtube`"
        )
        .setColor("RANDOM")
