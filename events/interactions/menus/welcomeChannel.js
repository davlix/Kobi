...
module.exports = async(interaction, client) => {
    ...
    if (interaction.values[0] === "welcome_channel") {
        ...
        if (!data) {
            msg.edit("Silakan kirim **CHANNEL ID** untuk disiapkan sebagai saluran Selamat Datang")
            ...
            collector.on('collect', async(collected, returnValue) => {
                ...
                if (!channel) return msg.edit("kami ga menemukan ID channel!")
                ...
                return msg.edit(`Welcome channel udah di atur ke ${interaction.guild.channels.cache.get(channelID)}`)
            })
            ...
            return msg.edit(`Welcome channel udah di hapus!`)
        }
    }
}